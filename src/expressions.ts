...
export const EXPRESSIONS: Record<string, ExpressionInfo> = {
    ...
    'target.tank': { type: 'target', description: 'Target role is tank' },
    'target.healer': { type: 'target', description: 'Target role is healer' },
    'target.dps': { type: 'target', description: 'Target role is DPS' },
    ...
    'focus.tank': { type: 'unit', description: 'Focus role is tank' },
    'focus.healer': { type: 'unit', description: 'Focus role is healer' },
    'focus.dps': { type: 'unit', description: 'Focus role is DPS' },
    ...
    'mouseover.tank': { type: 'unit', description: 'Mouseover role is tank' },
    'mouseover.healer': { type: 'unit', description: 'Mouseover role is healer' },
    'mouseover.dps': { type: 'unit', description: 'Mouseover role is DPS' },
    ...
    'cycle.tank': { type: 'cycle', description: 'Current cycle member role is tank' },
    'cycle.healer': { type: 'cycle', description: 'Current cycle member role is healer' },
    'cycle.dps': { type: 'cycle', description: 'Current cycle member role is DPS' },
